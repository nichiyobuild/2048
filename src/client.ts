...
class Game {
  ...
  boardCellsEl = document.getElementById('board-cells')!
  tileLayerEl = document.getElementById('tile-layer')!
  scoreEl = document.getElementById('score')!
  bestScoreEl = document.getElementById('best-score')!
  loseScoreEl = document.getElementById('lose-score')!
  winOverlayEl = document.getElementById('win-overlay')!
  loseOverlayEl = document.getElementById('lose-overlay')!
  ...
  move(direction: Direction) {
    ...
    const { board, scoreGained, moved, mergedCells } = applyMove(this.board, direction)
    if (!moved) return
  ...
  bindEvents() {
    ...
    document.getElementById('lose-restart-button')!.addEventListener('click', () => {
      this.start()
    })
    document.getElementById('keep-going-button')!.addEventListener('click', () => {
      this.keepGoing()
    })
  }
}
